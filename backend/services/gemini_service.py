...
{{
  ...
  "performance_badge": "<'Excellent', 'Good', or 'Needs Improvement'>",
  ...
  "suggested_answer": "<ideal professional answer generated by you>",
  "difficulty": "<'Easy', 'Medium', or 'Hard'>",
  "estimated_accuracy": <integer 0-100 representing accuracy percentage>
}}"""
    ...
    try:
        ...
        result["performance_badge"] = result.get("performance_badge", "Needs Improvement")
        result["strengths"] = result.get("strengths", [])
        result["missing_points"] = result.get("missing_points", [])
        result["suggested_answer"] = result.get("suggested_answer", "")
        result["difficulty"] = result.get("difficulty", "Medium")
        result["estimated_accuracy"] = int(result.get("estimated_accuracy", 50))
